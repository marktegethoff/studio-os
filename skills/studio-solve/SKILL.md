...
If neither exists, proceed with the embedded Studio OS context only, and ask: "What are the system invariants for this problem?"

---

## Studio OS Context (applied throughout)
...
This is not a veto — the loop continues regardless. But if the solution fails commercially, name it explicitly. The Creative Director's verdict must account for both dimensions.
