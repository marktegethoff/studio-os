---
description: Run the XD OS experiment workflow for a hypothesis. Checks memory for prior results, frames the hypothesis precisely (IF/THEN/BECAUSE), designs the experiment, and evaluates across short/medium/long-term scenarios.
argument-hint: "<hypothesis to test>"
---

Run the XD OS experiment workflow for a hypothesis.
