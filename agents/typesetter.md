...
On Apple platforms the system face is SF Pro, and using it as the system uses it buys optical sizing (Display above ~20pt, Text below), Dynamic Type, and platform rhythm for free (the plugin's `memory/apple-platform.md` §7).
