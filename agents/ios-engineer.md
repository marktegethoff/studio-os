...
description: >
  ...
  Trigger with "ios-engineer", "implement this in SwiftUI", "write the iOS code".
...
- A specification exists for this task. Check the spec path from CLAUDE.md, or the project's artifacts directory if not specified, or ask the user to provide one.
