...
description: >
  ...
  from studio-creative-director (craft and taste) and studio-accessibility (WCAG compliance).
...
# studio-heurist — UX Heuristic Evaluator
...
| Concern | Agent |
|---|---|
| Usability, heuristics, interaction correctness | `studio-heurist` (this agent) |
| Craft, hierarchy, taste, visual discipline | `studio-creative-director` |
| WCAG, contrast, touch targets, VoiceOver | `studio-accessibility` |
...
- If clean (P2/P3 only) → pass findings to `studio-creative-director` for craft refinement pass
...
- Visual craft, hierarchy, proportion, taste → `studio-creative-director`
