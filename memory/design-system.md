...
This file is loaded by `validate-design` to validate mockups against the project's design system. Define all rules here before running validation.

---

## How This File Works

Each section maps to a validation check. When `validate-design` runs, it applies each rule defined here as a checklist item. Undefined sections are skipped.
