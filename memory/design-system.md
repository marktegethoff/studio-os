...
This file is loaded by `design-validator` to validate mockups against the project's design system. Define all rules here before running validation.

---

## How This File Works

Each section maps to a validation check. When `design-validator` runs, it applies each rule defined here as a checklist item. Undefined sections are skipped.
