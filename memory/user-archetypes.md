...
Behavioral archetypes for this project — usage patterns and design implications, not demographic profiles. Written by studio-os:init and updated as the product's understanding of its users evolves.
...
*(Run `studio-os:init` to populate with archetypes for this project. Or add them manually using the template above.)*
